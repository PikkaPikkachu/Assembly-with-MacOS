...
_main:
    ...
    mov eax, 40           ; Number to be incremented
    inc eax            ; Increment by five times
    inc eax
    inc eax
    inc eax
    inc eax
    ...
    mov dword[esp+4], eax ; Second parameter at esp+4
...
;/usr/bin/nasm -f macho five.asm -o five.o && ld -macosx_version_min 10.8 -no_pie -arch i386 -o five five.o -lc
